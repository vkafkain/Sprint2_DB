...
SELECT grado.nombre AS grado, asignatura.tipo AS tipo_Asignatura, SUM(asignatura.creditos) AS creditos FROM grado JOIN asignatura ON grado.id = asignatura.id_grado GROUP BY asignatura.tipo, grado.id;
